...
career_suggestions = {
    ("людьми", "идеи", "офис"): "Маркетолог 🎯",
    ("компьютерами", "логика", "офис"): "Программист 👨‍💻",
    ("людьми", "логика", "на свежем воздухе"): "Инженер-строитель 🏗️",
    ("компьютерами", "идеи", "на свежем воздухе"): "Дизайнер интерьеров 🖌️"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("Привет! Я помогу тебе с выбором профессии. Отвечай на мои вопросы.")
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if len(user_answers[user_id]) < len(career_questions):
        ...
        suggestion = career_suggestions.get(key, career_suggestions)
